...
const defaultDemoScenario: DemoScenario = {
  ...
  warrants: [
    ...
    },
    {
      ...
      revocationReason: "The user revoked the Comms branch after an overreach attempt before approving outbound sends.",
      revocationSourceId: "revocation-comms-001",
      revokedBy: "user-maya-chen",
    },
    {
      id: "warrant-docs-child-001",
      parentId: "warrant-comms-child-001",
      rootRequestId: "request-investor-update-001",
      createdBy: "agent-comms-001",
      ...
      status: "revoked",
      revokedAt: "2026-04-17T09:12:00.000Z",
      revocationReason: "The parent Comms branch was revoked, so this descendant warrant was invalidated immediately.",
      revocationSourceId: "revocation-comms-001",
      revokedBy: "system",
    },
  ],
  actionAttempts: [
    ...
    },
    {
      ...
      agentId: "agent-docs-001",
      warrantId: "warrant-docs-child-001",
      requestedAt: "2026-04-17T09:13:00.000Z",
